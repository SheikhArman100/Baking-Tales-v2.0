...
const Shop = () => {
  ...
  return (
    <div className="w-full min-h-screen md:pt-[6rem] px-8 lg:px-[2rem] xl:px-[4rem] text-accentColor2 flex flex-col">
      ...
      {isPending ? (
        <div className="w-full flex-1 flex item-center justify-center">
          <span className="loading loading-dots loading-lg text-warning"></span>
        </div>
      ) :error? <div className="w-full flex-1 flex item-center justify-center">
          <p className="text-3xl text-textColor font2">Something went wrong</p>
        </div>:(
        <div className="mt-6 w-fit  pb-8  mx-auto ">
