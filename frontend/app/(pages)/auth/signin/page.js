...
const Signin = () => {
  return (
    <article className="w-full min-h-screen md:h-screen mt-4  text-accentColor2 border-t flex flex-col items-center justify-center   md:pt-[7rem] md:pb-8 px-8 lg:px-[2rem] xl:px-[4rem] md:grid md:grid-cols-2 ">
