    ...
    <section className="">
      ...
      <div ref={heroRef} className="relative h-[200vh] z-10 overflow-clip">
        <motion.div
          ...
          className="relative h-screen  mask [mask-position:center_center,center_top_80%] md:[mask-position:center_center,center_top_30%] bg-bgColor  w-full flex flex-col md:flex-row md:justify-center items-center px-6 md:px-[5rem] py-8 "
        >
